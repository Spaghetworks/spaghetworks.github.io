...
function UnreleasedVersionLabel({ siteTitle, versionMetadata }) {
  return (
    ...
    >
      {"This is documentation for the development branch of Spaghetworks."}
    </Translate>
  );
}
...
function FeatureBranchVersionLabel({ siteTitle, versionMetadata }) {
  return (
    <Translate
      id="theme.docs.versions.featureBranchVersionLabel"
      description="The label used to tell the user that they're browsing docs for a feature branch"
      values={{
        siteTitle,
        versionLabel: <b>{versionMetadata.label}</b>,
      }}
    >
      {"This is documentation for the {versionLabel} branch of {siteTitle}."}
    </Translate>
  );
}
const BannerLabelComponents = {
  ...
  feature: FeatureBranchVersionLabel,
};
function BannerLabel(props) {
  const BannerLabelComponent =
    BannerLabelComponents[
      props.versionMetadata.label?.includes("feature") ? "feature" : props.versionMetadata.banner
    ];
